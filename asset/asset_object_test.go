...
func Test_newAssetObject(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{"normal", args{"set", "set", big.NewInt(2), 18, common.Name(""), common.Name("a123"), big.NewInt(999999), ""}, &AssetObject{0, 0, 0, "set", "set", big.NewInt(2), 18, common.Name(""), common.Name("a123"), big.NewInt(2), big.NewInt(999999), common.Name(""), ""}, false},
		...
		{"symbolempty", args{"set", "", big.NewInt(2), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"amount==0", args{"set", "z", big.NewInt(-1), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"ownerempty", args{"set", "z", big.NewInt(2), 18, common.Name(""), common.Name(""), big.NewInt(999999), ""}, nil, true},
		{"shortsymbol", args{"set", "z", big.NewInt(2), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"longsymbol", args{"set", "ftt0123456789ftt1", big.NewInt(2), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"emptyname", args{"set", "#ip0123456789ft", big.NewInt(2), 18, common.Name("a123"), common.Name("a123"), big.NewInt(999999), ""}, nil, true},
		{"limiterror", args{"set", "set", big.NewInt(101), 18, common.Name(""), common.Name("a123"), big.NewInt(100), ""}, nil, true},
		{"descerror", args{"set", "set", big.NewInt(100), 18, common.Name(""), common.Name("a123"), big.NewInt(101),
...
func TestAssetObject_GetAssetID(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{"normal", fields{1, "set", "ft0123456789ft", big.NewInt(2), 18, common.Name(""), common.Name("a123"), big.NewInt(0), big.NewInt(999999)}, 1},
		{"max", fields{18446744073709551615, "set", "ft0123456789ft", big.NewInt(2), 18, common.Name(""), common.Name("a123"), big.NewInt(0), big.NewInt(999999)}, 18446744073709551615},
		//{"min", fields{0, "set", "ft0123456789ft", big.NewInt(2), 18, common.Name("a123")}, 0},
		//{">max", fields{18446744073709551616, "set", "ft0123456789ft", big.NewInt(2), 18, common.Name("a123")}, 0},
	}
	for _, tt := range tests {
		ao := &AssetObject{
...
func TestAssetObject_SetAssetID(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		//{">max", fields{0, "set", "ft0123456789ft", big.NewInt(2), 18, common.Name("a123")}, args{18446744073709551616}},
		{"max", fields{0, "set", "ft0123456789ftft", big.NewInt(2), 18, common.Name("a123")}, args{18446744073709551615}},
		{"normal", fields{0, "set", "ft0123456789ft", big.NewInt(2), 18, common.Name("a123")}, args{184467}},
	}
	for _, tt := range tests {
		ao := &AssetObject{
			AssetID:   tt.fields.AssetID,
