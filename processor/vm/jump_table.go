...
func NewFrontierInstructionSet() [256]operation {
	return [256]operation{
		...
		EXTVALUE1: {
			execute:       makeExtValue(1),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTASSETID2: {
			execute:       makeExtAssetID(2),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTVALUE2: {
			execute:       makeExtValue(2),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTASSETID3: {
			execute:       makeExtAssetID(3),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTVALUE3: {
			execute:       makeExtValue(3),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTASSETID4: {
			execute:       makeExtAssetID(4),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTVALUE4: {
			execute:       makeExtValue(4),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTASSETID5: {
			execute:       makeExtAssetID(5),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTVALUE5: {
			execute:       makeExtValue(5),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTASSETID6: {
			execute:       makeExtAssetID(6),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTVALUE6: {
			execute:       makeExtValue(6),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTASSETID7: {
			execute:       makeExtAssetID(7),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTVALUE7: {
			execute:       makeExtValue(7),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTASSETID8: {
			execute:       makeExtAssetID(8),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
		EXTVALUE8: {
			execute:       makeExtValue(8),
			gasCost:       constGasFunc(GasQuickStep),
			validateStack: makeStackFunc(0, 1),
			valid:         true,
		},
