...
func getAccountManager() *AccountManager {
	...
	am.CreateAccount(common.Name("set.founder"), common.Name("systestname"), common.Name(""), 0, 0, *pubkey, "")
	return am
}
...
func TestNN(t *testing.T) {
	if err := accountManager.CreateAccount(common.Name("set.founder"), common.Name("a123asdf2"), common.Name(""), 0, 0, *new(common.PubKey), ""); err != nil {
...
func TestAccountManager_CreateAccount(t *testing.T) {
	...
	tests := []struct {
		...
		//
		{"createAccount", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("a111222332a"), common.Name(""), pubkey3}, false},
		{"createAccountWithEmptyKey", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("a123456789aeee"), common.Name(""), *pubkey2}, false},
		{"createAccountWithEmptyKey", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("a123456789aeed"), common.Name(""), *pubkey}, false},
		{"createAccountWithInvalidName", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("a12345678-aeee"), common.Name(""), *pubkey}, true},
		{"createAccountWithInvalidName", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("a123456789aeeefgp"), common.Name(""), *pubkey}, true},
		{"creategensisAccount", fields{sdb, ast}, args{common.Name("set"), common.Name("set.account"), common.Name(""), *pubkey}, false},
		{"creategensisAccount1", fields{sdb, ast}, args{common.Name("set"), common.Name("set.asset"), common.Name(""), *pubkey}, false},
		{"createinvalidAccount0", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("\ttesttestf1"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount1", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("testtestf1.."), common.Name(""), *pubkey}, true},
		{"createinvalidAccount2", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("set.account"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount3", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("set.founder.1"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount4", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("set.founder.12"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount5", fields{sdb, ast}, args{common.Name("set"), common.Name("set.founder1234"), common.Name(""), *pubkey}, true},
	}
	for _, tt := range tests {
		am := &AccountManager{
			sdb: tt.fields.sdb,
	...
	err := am1.CreateAccount(common.Name("set.founder"), common.Name("aaaadddd"), common.Name("a111222332a"), 0, 0, *pubkey, "")
	if err != nil {
...
func TestAccountManager_SetAccount(t *testing.T) {
	...
	pubkey2 := new(common.PubKey)
	accountManager.CreateAccount(common.Name("set.founder"), common.Name("a123456789"), common.Name(""), 0, 0, *pubkey2, "")
...
func TestAccountManager_GetCode(t *testing.T) {
	...
	accountManager.CreateAccount(common.Name("set.founder"), common.Name("a123456789aeed"), common.Name("a123456789aeed"), 0, 0, *pubkey2, "")
...
func Test_IssueAssetForkID1(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{"normal", args{"set", "set", big.NewInt(2), 18, common.Name(""), common.Name("a0123456789abc"), big.NewInt(999999), "", ""}, true},
		...
		{"symbolempty", args{"set", "", big.NewInt(2), 18, common.Name("a0123456789abc"), common.Name("a0123456789abc"), big.NewInt(999999), "", ""}, false},
		{"amount==0", args{"set", "z", big.NewInt(-1), 18, common.Name("a0123456789abc"), common.Name("a0123456789abc"), big.NewInt(999999), "", ""}, false},
		{"ownerempty", args{"set", "z", big.NewInt(2), 18, common.Name(""), common.Name(""), big.NewInt(999999), "", ""}, false},
		{"shortsymbol", args{"set", "z", big.NewInt(2), 18, common.Name("a0123456789abc"), common.Name("a0123456789abc"), big.NewInt(999999), "", ""}, false},
		{"longsymbol", args{"set", "ftt0123456789ftt1", big.NewInt(2), 18, common.Name("a0123456789abc"), common.Name("a0123456789abc"), big.NewInt(999999), "", ""}, false},
		{"emptyname", args{"set", "#ip0123456789ft", big.NewInt(2), 18, common.Name("a0123456789abc"), common.Name("a0123456789abc"), big.NewInt(999999), "", ""}, false},
	}
	...
	//create account
	err := am.CreateAccount(common.Name("set.founder"), newAccount, "", 0, 0, *pubkey, "")

	if err != nil {
		t.Errorf("Test_IssueAssetForkID1 create account error = %v", err)
	}

	argBeforeFork := args{"main", "set", big.NewInt(2), 18, common.Name(""), common.Name("a0123456789abc"), big.NewInt(999999), "", ""}
	argSubFork := args{"main.sub", "set", big.NewInt(2), 18, common.Name(""), common.Name("a0123456789abc"), big.NewInt(999999), "", ""}
	...
	argAfterFork := args{"test", "set", big.NewInt(2), 18, common.Name(""), common.Name("a0123456789abc"), big.NewInt(999999), "", ""}
...
func Test_GetAccountNameLevel(t *testing.T) {
	level, err := GetAccountNameLevel("set")

	if level != 1 || err != nil {
		t.Errorf("account level 1 test failed, level:%v, err:%v", level, err)
	}

	level, err = GetAccountNameLevel("set.test")
...
func Test_CheckAssetContract(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{"assetContract", args{"set.contract", "set.contract", "set.test"}, true},
		{"assetContract", args{"set.contract", "set.test1", "set.test"}, false},
	}
...
func TestAccountManager_CreateAccountFork1(t *testing.T) {
	...
	tests := []struct {
		...
		{"createAccount", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("a111222332afork"), common.Name(""), pubkey3}, false},
		...
		{"createAccountWithEmptyKey", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("a123456789fork"), common.Name(""), *pubkey2}, false},
		{"createAccountWithEmptyKey", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("a123456789afork"), common.Name(""), *pubkey}, false},
		{"createAccountWithInvalidName", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("a12345678-fork"), common.Name(""), *pubkey}, true},
		{"createAccountWithInvalidName", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("a123456789aeeefork"), common.Name(""), *pubkey}, true},
		{"createAccountNameInvalid", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("a12345678b"), common.Name(""), pubkey3}, true},
		{"createinvalidAccount0", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("\ttesttestf1"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount1", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("testtestf1.."), common.Name(""), *pubkey}, true},
		{"createinvalidAccount2", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("set.account"), common.Name(""), *pubkey}, true},
		{"createinvalidAccount3", fields{sdb, ast}, args{common.Name("set.founder"), common.Name("set.founder.1"), common.Name(""), *pubkey}, true},
...
func TestAccountManager_AccountHaveCode(t *testing.T) {
	...
	err := am.CreateAccount(common.Name("set.founder"), common.Name("a111222332code"), common.Name(""), 0, 1, pubkey, "")
	if err != nil {
