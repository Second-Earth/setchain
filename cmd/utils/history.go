...
var History relic.ImmutableHistory = relic.NewHistory("set", "https://github.com/Second-Earth/setchain").
	MustDeclareReleases(
		"1.0.0 - 2019-12-09",
		`### Forked
...
- [CMD] cmd/set: add method 'seednodes' into sub-cmd 'p2p' (#497)
...
### Changed
- [RAWDB] modify set db interface (#487)
...
`,
		"0.0.28 - 2019-09-04",
		`### Fixed
- [P2P] bootnode in genesis is set finder.(#439)
...
- [P2P] setfinder: add cmd flag that can input genesis block hash
### Added
...
- [FEE] the distributed gas will add to set.fee's balance
