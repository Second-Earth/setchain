...
var (
	// ConfigFile the set config file
	ConfigFile string
)
...
func addFlags(flags *flag.FlagSet) {
	...
	viper.BindPFlag("setservice.databasecache", flags.Lookup("database_cache"))
	...
	viper.BindPFlag("setservice.contractlog", flags.Lookup("contractlog"))
	...
	viper.BindPFlag("setservice.statepruning", flags.Lookup("statepruning_enable"))
	...
	viper.BindPFlag("setservice.startnumber", flags.Lookup("start_number"))
	...
	viper.BindPFlag("setservice.badhashes", flags.Lookup("bad_hashes"))
	...
	viper.BindPFlag("setservice.txpool.nolocals", flags.Lookup("txpool_nolocals"))
	...
	viper.BindPFlag("setservice.txpool.journal", flags.Lookup("txpool_journal"))
	...
	viper.BindPFlag("setservice.txpool.rejournal", flags.Lookup("txpool_rejournal"))
	...
	viper.BindPFlag("setservice.txpool.pricebump", flags.Lookup("txpool_pricebump"))
	...
	viper.BindPFlag("setservice.txpool.pricelimit", flags.Lookup("txpool_pricelimit"))
	...
	viper.BindPFlag("setservice.txpool.accountslots", flags.Lookup("txpool_accountslots"))
	...
	viper.BindPFlag("setservice.txpool.accountqueue", flags.Lookup("txpool_accountqueue"))
	...
	viper.BindPFlag("setservice.txpool.globalslots", flags.Lookup("txpool_globalslots"))
	...
	viper.BindPFlag("setservice.txpool.globalqueue", flags.Lookup("txpool_globalqueue"))
	...
	viper.BindPFlag("setservice.txpool.lifetime", flags.Lookup("txpool_lifetime"))
	...
	viper.BindPFlag("setservice.txpool.resendtime", flags.Lookup("txpool_resendtime"))
	...
	viper.BindPFlag("setservice.txpool.minbroadcast", flags.Lookup("txpool_minbroadcast"))
	...
	viper.BindPFlag("setservice.txpool.ratiobroadcast", flags.Lookup("txpool_ratiobroadcast"))
	...
	viper.BindPFlag("setservice.miner.start", flags.Lookup("miner_start"))
	...
	viper.BindPFlag("setservice.miner.delay", flags.Lookup("miner_delay"))
	...
	viper.BindPFlag("setservice.miner.name", flags.Lookup("miner_name"))
	...
	viper.BindPFlag("setservice.miner.private", flags.Lookup("miner_private"))
	...
	viper.BindPFlag("setservice.miner.name", flags.Lookup("miner_extra"))
	...
	viper.BindPFlag("setservice.gpo.blocks", flags.Lookup("gpo_blocks"))
	...
	viper.BindPFlag("setservice.metrics.start", flags.Lookup("metrics_start"))
	...
	viper.BindPFlag("setservice.metrics.influxdb", flags.Lookup("metrics_influxdb"))
	...
	viper.BindPFlag("setservice.metrics.influxdbURL", flags.Lookup("metrics_influxdb_URL"))
	...
	viper.BindPFlag("setservice.metrics.influxdbname", flags.Lookup("metrics_influxdb_name"))
	...
	viper.BindPFlag("setservice.metrics.influxdbuser", flags.Lookup("metrics_influxdb_user"))
	...
	viper.BindPFlag("setservice.metrics.influxdbpasswd", flags.Lookup("metrics_influxdb_passwd"))
	...
	viper.BindPFlag("setservice.metrics.influxdbnamepace", flags.Lookup("metrics_influxdb_namespace"))
	...
	viper.BindPFlag("setservice.p2p.networkid", flags.Lookup("p2p_id"))
	...
	viper.BindPFlag("setservice.p2p.name", flags.Lookup("p2p_name"))
	...
	viper.BindPFlag("setservice.p2p.maxpeers", flags.Lookup("p2p_maxpeers"))
	...
	viper.BindPFlag("setservice.p2p.maxpendpeers", flags.Lookup("p2p_maxpendpeers"))
	...
	viper.BindPFlag("setservice.p2p.dialratio", flags.Lookup("p2p_dialratio"))
	...
	viper.BindPFlag("setservice.p2p.peerperiod", flags.Lookup("p2p_peerperiod"))
	...
	viper.BindPFlag("setservice.p2p.listenaddr", flags.Lookup("p2p_listenaddr"))
	...
	viper.BindPFlag("setservice.p2p.nodedb", flags.Lookup("p2p_nodedb"))
	...
	viper.BindPFlag("setservice.p2p.nodiscovery", flags.Lookup("p2p_nodiscovery"))
	...
	viper.BindPFlag("setservice.p2p.nodial", flags.Lookup("p2p_nodial"))
	...
	viper.BindPFlag("setservice.p2p.bootnodes", flags.Lookup("p2p_bootnodes"))
	...
	viper.BindPFlag("setservice.p2p.staticnodes", flags.Lookup("p2p_staticnodes"))
	...
	viper.BindPFlag("setservice.p2p.trustnodes", flags.Lookup("p2p_trustnodes"))
