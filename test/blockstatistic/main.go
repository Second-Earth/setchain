...
import (
	...
	"github.com/Second-Earth/setchain/sdk"
)
...
func main() {
	_rpchost := flag.String("u", "http://192.168.2.11:3090", "RPC host")
	_start := flag.Uint64("s", 1, "Start height")
	_end := flag.Uint64("e", 0, "End height")
	_detail := flag.Bool("d", true, "display details?")
	flag.Parse()
	...
	if timeEnd < timeStart {
		panic("The start time is greater than the end time")
	}
