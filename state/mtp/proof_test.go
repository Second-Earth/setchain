...
import (
	...
	mdb "github.com/Second-Earth/setchain/utils/fdb/memdb"
)
...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *mdb.MemDatabase {
	var provers []func(key []byte) *mdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *mdb.MemDatabase {
		proof := mdb.NewMemDatabase()
