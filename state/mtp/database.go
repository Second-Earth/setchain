...
type Database struct {
	diskdb fdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb fdb.Database) *Database {
	return &Database{
		diskdb:    diskdb,
...
func (db *Database) commit(hash common.Hash, batch fdb.Batch) error {
